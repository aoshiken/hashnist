...
bool check_hashes_file( char *file_path )
{
    ...
    {
        if ( statbuf.st_size && ( ! ( statbuf.st_size % 32 ) ) )
...
void show_help( char *progname )
{
    ...
    fprintf(stderr, "\nGenerate a file of MD5 hashes in binary format according to a source file\n");
    fprintf(stderr, "with JUST ONE LINE of ordered MD5 hashes in text format (all of the hashes\n");
    fprintf(stderr, "are stored in JUST ONE LINE with no blanks between).\n");
    fprintf(stderr, "The MD5 hashes of the source text file comes from the NIST National Software\n");
    fprintf(stderr, "Reference Library catalog.\n\n");
    fprintf(stderr, "Usage:\n    %s [-h] [-V] {-i file_path} {-o file_path}\n", cur);
    fprintf(stderr, "\nOptions:\n");
    fprintf(stderr, "    -h, --help                  This help screen\n");
    fprintf(stderr, "    -i --input-file  file_path  Input file with ordered MD5 hashes in text format\n");
    fprintf(stderr, "    -o --output-file file_path  Output file with MD5 hashes in binary format\n");
